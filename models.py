...
def init():
    ...
    if PG_MODE:
        ...
        try:
            ...
            pass
        try:
            c.execute("ALTER TABLE sequencias_banco ADD COLUMN IF NOT EXISTS fabrica_id INTEGER")
        except Exception:
            pass
        try:
        ...
        try:
            ...
            pass
        try:
            c.execute("ALTER TABLE sequencias_banco ADD COLUMN fabrica_id INTEGER")
        except Exception:
            pass
        try:
